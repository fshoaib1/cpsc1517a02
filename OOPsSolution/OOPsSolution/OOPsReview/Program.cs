...
namespace OOPsReview
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The fence is to be " + ClientEstimate.Panel.Style + "style");
            Console.WriteLine("the fence length is required is {0}", ClientEstimate.LinearLength);
            ...
            //walking thru each item, otherwise we need an index and a list

            Console.WriteLine(string.Format("Total fence surface Area {0:0.00}", fenceArea * 2));
            Console.ReadKey(); //required due to using just FS
